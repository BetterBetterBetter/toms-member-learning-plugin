...
class TSOL_Library_Content_Access_Column {
    ...
    public function enqueue_assets($hook) {
        ...
        wp_enqueue_style(
            ...
            TSOL_SITE_PLUGIN_URL . 'assets/features/library-content/access-column.css',
            array(),
            TSOL_SITE_PLUGIN_VERSION
        );
        wp_enqueue_script(
            'tsol-library-content-access-column',
            TSOL_SITE_PLUGIN_URL . 'assets/features/library-content/access-column.js',
            array(),
            TSOL_SITE_PLUGIN_VERSION,
            true
        );
    ...
    private static function is_access_list_screen($screen) {
        ...
        return in_array((string) $screen->post_type, TSOL_Library_Content_Model::post_types(), true);
    }
}
